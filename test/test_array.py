...
class TestArray:
    ...
    """
    @pytest.mark.parametrize("data, empty_value, total_width, box_type, box_color, text_scale", [
        ([1, 2, 3, ' ', 'a'], '/',  10, Square, RED, 1.0),
    ])
    def test_array_initialization(self, data, empty_value, total_width, box_type, box_color, text_scale):
        array = Array(data, empty_value, total_width, box_type, box_color, text_scale)
